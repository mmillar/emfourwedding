...
function stag_general_settings(){
    $general_settings['description'] = __('Configure general settings of your theme. Upload your preferred logo, favicon, and insert your analytics tracking code.', 'stag');
  ...
  $general_settings[] = array(
    ...
    $general_settings[] = array(
		'title' => __('Number of Guestbook messages per page', 'stag'),
		'desc'  => __('Specify the number of guestbook messages per page', 'stag'),
		'type'  => 'text',
    ...
    stag_add_framework_page( __('General Settings', 'stag'), $general_settings, 5 );
}
