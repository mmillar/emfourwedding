        ...
        <div class="blog-cover">
            ...
            <div class="center blog-title-wrap">
                <div class="blog-title-inner-wrap">
                    <?php if(stag_get_option('blog_title') != '') echo '<h4 class="section-title">'.stripcslashes(stag_get_option('blog_title')).'</h4>'; ?>
                    <?php if(stag_get_option('blog_subtitle') != '') echo '<h4 class="sub-title">'. stripcslashes(stag_get_option('blog_subtitle')) .'</h4>'; ?>
                </div>
            </div>
            <?php endif; ?>
        </div>
